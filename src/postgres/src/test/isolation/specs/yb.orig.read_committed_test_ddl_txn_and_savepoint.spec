...
# Query layer retry should succeed for the two add column DDLs with ROLLBACK.
# permutation "b1" "b2" "s1_add_column_a" "s2_add_column_b" "r1" "c2" "select_test"

# Query layer retry should succeed for the two add column DDLs with COMMIT.
permutation "b1" "b2" "s1_add_column_a" "s2_add_column_b" "c1" "c2" "select_test"
