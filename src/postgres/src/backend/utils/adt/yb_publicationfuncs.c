/*--------------------------------------------------------------------------------------------------
*
* yb_publicationfuncs.c
*	  Functions for SQL access to YugabyteDB publications (CDC streams)
*
...
*
* IDENTIFICATION
*		src/backend/utils/adt/yb_publicationfuncs.c
*
*--------------------------------------------------------------------------------------------------
*/
...
/* Number of columns in yb_publication_properties output */
#define YB_NUM_LOCK_STATUS_COLUMNS 21

/*
 * yb_publication_properties - produce a view with one row per held or awaited lock
 */
Datum
yb_publication_properties(PG_FUNCTION_ARGS)
{
	FuncCallContext *funcctx;
	YbFuncCallContext yb_funcctx;

    // TODO: define a similar auto flag?
