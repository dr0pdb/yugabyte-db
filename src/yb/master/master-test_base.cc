...
Status MasterTestBase::CreatePgsqlNamespace(
  ...
  RETURN_NOT_OK(CreateNamespaceAsyncWithRequest(req, resp));
...
Status MasterTestBase::CreateNamespaceAsync(const NamespaceName& ns_name,
  ...
  return CreateNamespaceAsyncWithRequest(req, resp);
}

Status MasterTestBase::CreateNamespaceAsyncWithRequest(const CreateNamespaceRequestPB& req,
                                            CreateNamespaceResponsePB* resp) {
